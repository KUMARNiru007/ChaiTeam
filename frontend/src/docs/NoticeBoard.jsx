...
const NoticeBoard = () => {
  ...
  const filteredNotices = noticesData.filter(notice => {
    ...
    const matchesScope = selectedScope === 'All Scopes' || notice.scope === selectedScope;
    ...
    <div style={{ padding: '1.5rem' }}>
      ...
      {loading ? (
        <div style={{ textAlign: 'center', padding: '2rem' }}>
          ...
          `}</style>
          <p style={{ marginTop: '1rem', color: '#b3b3b3' }}>Loading notices...</p>
        </div>
      ) : error ? (
            ...
            filteredNotices.map(notice => (
              ...
              >
                <div style={{
                  ...
                  <span style={{
                    backgroundColor: notice.type === 'URGENT' ? '#ff4d4f33' : 
                                  notice.type === 'ANNOUNCEMENT' ? '#1890ff33' : '#52c41a33',
                    color: notice.type === 'URGENT' ? '#ff4d4f' : 
                          notice.type === 'ANNOUNCEMENT' ? '#1890ff' : '#52c41a',
                    fontSize: '0.75rem',
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                    <i className="ri-time-line" style={{ color: '#b3b3b3', marginRight: '0.5rem' }}></i>
                    <span style={{ color: '#b3b3b3', fontSize: '0.75rem' }}>
                  ...
                  <span style={{
                    backgroundColor: notice.scope === 'GROUP' ? '#52c41a33' : 
                                  notice.scope === 'BATCH' ? '#1890ff33' : '#faad1433',
                    color: notice.scope === 'GROUP' ? '#52c41a' : 
                          notice.scope === 'BATCH' ? '#1890ff' : '#faad14',
                    fontSize: '0.75rem',
                    padding: '0.25rem 0.5rem',
                    borderRadius: '0.25rem',
                    textTransform: 'capitalize'
