      ...
      >
        ...
        <div className='flex justify-center gap-4 pb-2'>
          <button
            ...
            className={`relative inline-flex items-center justify-center box-border appearance-none select-none whitespace-nowrap font-normal subpixel-antialiased overflow-hidden bg-transparent px-4 min-w-20 h-10 gap-2 !rounded-md !border-[1px] py-5 cursor-pointer ${
              darkMode
